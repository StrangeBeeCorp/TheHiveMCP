...
- Your **TheHive URL**, an **API key**, and your **organization** name.
- **Claude Desktop** installed ([download](https://claude.ai/download)).

We use Claude Desktop here because it's the quickest host to get running. If you prefer the terminal, the [Claude Code how-to](../how-to/setup-claude-code.md)
...
Open the Claude Desktop configuration file—**Settings → Developer → Edit Config**—and add a `thehive` server under `mcpServers`. Replace the four values with
your own:
...
- To let the assistant **create and update** entities safely, learn the permission model in the [permissions reference](../reference/permissions.md)—start
  restrictive, then grant only what a role needs.
