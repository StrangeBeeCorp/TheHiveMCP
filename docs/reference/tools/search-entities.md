...
| `offset`             | number  | No       | Index of the first result to return, for paging (default: 0, maximum: 10000). See [Paging](#paging-through-a-large-result-set).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
- **`offset` is capped at 10000.** Beyond that Elasticsearch refuses the query outright. Narrow the filter — or use `count: true` if all you need is the size of
  the match, which is exact and unaffected by `limit` and `offset`.
