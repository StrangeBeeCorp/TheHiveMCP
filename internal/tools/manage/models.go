...
type EntityParams struct {
	Operation  string         `json:"operation"             jsonschema_description:"The operation to perform on the entity."`
	EntityType string         `json:"entity-type"           jsonschema_description:"The type of entity to manage."`
