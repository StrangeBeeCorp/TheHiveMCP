...
const EnvKeyAllowEnvCredentialFallback EnvKey = "ALLOW_ENV_CREDENTIAL_FALLBACK"
...
const FlagVarAllowEnvCredentialFallback FlagVar = "allow-env-credential-fallback"
